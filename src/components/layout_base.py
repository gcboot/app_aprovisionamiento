        ...
        children=[
            ...
            dmc.NavLink(
                ...
                children=[
                    ...
                    dmc.NavLink(label="Promociones", href="/home/promociones", id="nav-mantenimientos-promociones"),
                    dmc.NavLink(label="Productos Campaña", href="/home/productos_campania", id="nav-mantenimientos-producto-campania"),
                    dmc.NavLink(label="Productos Promoción", href="/home/promocion_producto", id="nav-mantenimientos-promocion-producto"),
                    dmc.NavLink(label="📂 Staging ETL", href="/home/ventas", id="nav-mantenimientos-staging"),
                ]),
            dmc.Space(h=20),
