        ...
        children=[
            ...
            dmc.NavLink(
                ...
                children=[
                    ...
                    dmc.NavLink(label="Productos por Campaña", href="/home/productos_campania", id="nav-mantenimientos-producto-campania"),
                    dmc.NavLink(label="Productos por Promoción", href="/home/promocion_producto", id="nav-mantenimientos-promocion-producto"),
                ]),
            dmc.Space(h=20),
